...
export declare class Tabs extends React.PureComponent<TabsProps, StateType> {
    ...
    isTabVertical: (direction?: "horizontal" | "vertical" | undefined) => direction is "vertical";
    ...
    renderTabBar(tabBarProps: any, DefaultTabBarComponent: React.ComponentClass): React.ReactNode;
